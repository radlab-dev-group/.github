export const translations = {
  pl: {
    ...
    'security.description': 'LLM Router został zbudowany z ochroną danych w centrum, odpowiedni dla organizacji dowolnej wielkości, gdzie bezpieczeństwo danych ma znaczenie. Każde żądanie jest automatycznie chronione przez dwuwarstwowy system bezpieczeństwa: guardrails walidujące bezpieczeństwo treści przed przetwarzaniem oraz pipeline maskerów anonimizujące wrażliwe dane przed transmisją—czy to do lokalnych modeli (vLLM, Ollama, LM Studio), czy dostawców chmurowych. Zachowaj wrażliwe dane bezpiecznie w swojej infrastrukturze zapewniając zgodność z RODO, HIPAA, SOC2 i innymi ramami regulacyjnymi.',
    ...
    'security.guardrails.feature2': 'Integracja NASK Guard dla bezpieczeństwa treści w języku polskim (model PL-Guard)',
    ...
    'security.masking.feature1': 'Automatyczne wykrywanie i maskowanie danych osobowych (zgodność z RODO/CCPA/HIPAA)',
    'security.masking.feature2': 'Wsparcie dla międzynarodowych identyfikatorów: SSN, numery podatkowe, numery ID, numery rejestracyjne firm',
    'security.masking.feature3': 'Maskowanie danych finansowych (numery kont, karty kredytowe, kwoty transakcji)',
    ...
    'usecases.security.title': '🛡️ Wielowarstwowe Bezpieczeństwo z Guardrails i Maskowaniem',
    'usecases.security.problem': '<strong>Wyzwanie:</strong> Organizacje potrzebują zarówno walidacji bezpieczeństwa treści, jak i ochrony danych przed wysłaniem żądań do dostawców LLM, ale implementacja tych kontroli wymaga złożonej infrastruktury.',
    ...
    'usecases.security.feature1': 'Sekwencyjna walidacja guardrails (NASK Guard + własne pluginy)',
    'usecases.security.feature2': 'Automatyczne maskowanie PII z 15+ typami reguł',
  ...
  en: {
    ...
    'security.description': 'LLM Router is built with data protection at its core, suitable for organizations of any size where data security matters. Every request is automatically protected through a two-layer security system: <strong>guardrails</strong> that validate content safety before processing, and <strong>masking pipelines</strong> that anonymize sensitive data before transmission—whether to your local models (vLLM, Ollama, LM Studio) or cloud providers. Keep sensitive data secure within your infrastructure while ensuring compliance with GDPR, HIPAA, SOC2, and other regulatory frameworks.',
    'security.guardrails.title': 'Guardrails - Content Safety Layer',
    'security.guardrails.feature1': 'Multi-stage guardrail pipelines for content validation and safety checks',
    'security.guardrails.feature2': 'NASK Guard integration for Polish language content safety (PL-Guard model)',
    'security.guardrails.feature3': 'Extensible plugin architecture for custom guardrail implementations',
    'security.guardrails.feature4': 'Request blocking for unsafe or prohibited content before LLM processing',
    ...
    'security.masking.feature1': 'Automatic PII detection and masking (GDPR/CCPA/HIPAA compliant)',
    'security.masking.feature2': 'Support for international identifiers: SSN, tax IDs, national IDs, business registration numbers',
    'security.masking.feature3': 'Financial data masking (account numbers, credit cards, transaction amounts)',
    'security.masking.feature4': 'Checksum validation for detected identifiers ensuring accuracy',
    'security.masking.feature5': 'Extensible masking engine with custom rule support for industry-specific requirements',
    'security.masking.feature6': 'Multi-plugin masking pipelines with sequential data transformation',
    'security.masking.feature7': 'Enforced anonymization with configurable strategies across entire payload',
    'security.code.comment1': '# =======================================',
    ...
    'usecases.security.title': '🛡️ Multi-Layer Security with Guardrails & Masking',
    'usecases.security.problem': '<strong>Challenge:</strong> Organizations need both content safety validation and data protection before sending requests to LLM providers, but implementing these controls requires complex infrastructure.',
    'usecases.security.solution': '<strong>Solution:</strong> LLM Router provides a two-layer security system: <strong>guardrail pipelines</strong> validate content safety and block prohibited requests, while <strong>masking pipelines</strong> automatically anonymize sensitive data. Configure sequential processing stages for both guardrails and maskers, ensuring complete protection before requests reach any LLM provider.',
    'usecases.security.feature1': 'Sequential guardrail validation (NASK Guard + custom plugins)',
    'usecases.security.feature2': 'Automatic PII masking with 15+ rule types',
