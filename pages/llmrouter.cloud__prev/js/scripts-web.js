const sections = [
  { selector: '#header',        url: 'sections/web/header.html' },
  { selector: '#hero',          url: 'sections/web/hero.html' },
  { selector: '#overview',      url: 'sections/web/overview.html' },
  { selector: '#applications',  url: 'sections/web/applications.html' },
  { selector: '#architecture',  url: 'sections/web/architecture.html' },
  { selector: '#configuration', url: 'sections/web/configuration.html' },
  { selector: '#request-flow',  url: 'sections/web/usage-workflow.html' },
  { selector: '#endpoints',     url: 'sections/web/endpoints.html' },
  { selector: '#footer',        url: 'sections/web/footer.html' },
];
